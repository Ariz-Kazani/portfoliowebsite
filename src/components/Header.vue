  ...
  <div id="header-con">
    ...
    <div id="socials">
      <a @click="logEvent(an, 'Clicked A Social Link', { linkName: 'LinkedIn' });"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="var(--secondary)" class="bi bi-linkedin"
          viewBox="0 0 16 16">
          <path
      ...
      <a @click="logEvent(an, 'Clicked A Social Link', { linkName: 'GitHub' });" href="https://github.com/Ariz-Kazani"
        target="_blank">
        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="var(--secondary)" class="bi bi-github"
          viewBox="0 0 16 16">
          <path
