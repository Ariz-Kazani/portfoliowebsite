...
const projects = ref([
  ...
  },
  {
    ...
    hostingLink: null,
    codeLink: null,
    technologies: ["unity", "csharp", "android", "ios"],
  ...
  },
  {
    ...
    photo: theMovieIMG,
    description: `The Movie is a web app that allows users to search for movies, and view their details. The Movie uses the TMDb API, Vue.js, Firebase.`,
    id: 'the-movie',
  },
  {
    name: 'Search Engine',
